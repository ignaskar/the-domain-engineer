...
VALUES (sqlc.arg(order_uuid), sqlc.arg(restaurant_uuid), sqlc.arg(courier_uuid), sqlc.arg(currency), sqlc.arg(commission_net_amount), sqlc.arg(ordered_at))
...
VALUES (sqlc.arg(order_uuid), sqlc.arg(breakdown_type), sqlc.arg(net_amount), sqlc.arg(tax_amount), sqlc.arg(gross_amount))
